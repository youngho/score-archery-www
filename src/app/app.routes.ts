...
export const routes: Routes = [
  ...
  { path: 'features', loadComponent: () => import('./components/features/features.component').then(m => m.FeaturesComponent) },
  { path: 'arrows', loadComponent: () => import('./components/arrows/arrows.component').then(m => m.ArrowsComponent) },
